<div class="down40" id="plan-12-form" style="display:none;"> 
    <div class="row">
        <div class="col-xs-12 text-center">
            <h2>NBN Group Plan 12 Only</h2>
        </div>
    </div>
    <div class="row down40">
        ...
        <div class="col-xs-12 col-md-4">
            <select name="p12[type]" id="type-select" class="full-width">
        ...
        <div class="col-xs-12 col-md-2">
            <div class="input-group">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="minus" data-field="p12[type-amount]">
                    <span class="fa fa-minus-circle"></span>
                    </button>
                </span>
                <input type="text" name="p12[type-amount]" class="input-number" value="0" min="0" max="100">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="plus" data-field="p12[type-amount]">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
            <select name="p12[material]" id="material-select" class="full-width">
                <option>Select</option>
        ...
        <div class="col-xs-12 col-md-2">
            <div class="input-group">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="minus" data-field="p12[material-amount]">
                    <span class="fa fa-minus-circle"></span>
                    </button>
                </span>
                <input type="text" name="p12[material-amount]" class="input-number" value="0" min="0" max="100">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="plus" data-field="p12[material-amount]">
                        <span class="fa fa-plus-circle"></span>
                    </button>
                </span>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
            <select name="p12[tint]" id="tint-select" class="full-width">
                <option>Select</option>
        ...
        <div class="col-xs-12 col-md-2">
            <div class="input-group">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="minus" data-field="p12[tint-amount]">
                    <span class="fa fa-minus-circle"></span>
                    </button>
                </span>
                <input type="text" name="p12[tint-amount]" class="input-number" value="0" min="0" max="100">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="plus" data-field="p12[tint-amount]">
                        <span class="fa fa-plus-circle"></span>
                    </button>
                </span>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
            <select name="p12[coating]" id="coating-select" class="full-width">
                <option>Select</option>
        ...
        <div class="col-xs-12 col-md-2">
            <div class="input-group">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="minus" data-field="p12[coating-amount]">
                    <span class="fa fa-minus-circle"></span>
                    </button>
                </span>
                <input type="text" name="p12[coating-amount]" class="input-number" value="0" min="0" max="100">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="plus" data-field="p12[coating-amount]">
                        <span class="fa fa-plus-circle"></span>
                    </button>
                </span>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
            <select name="p12[edge-treatment]" id="edge-treatment-select" class="full-width">
                <option>Select</option>
        ...
        <div class="col-xs-12 col-md-2">
            <div class="input-group">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="minus" data-field="p12[edge-treatment-amount]">
                    <span class="fa fa-minus-circle"></span>
                    </button>
                </span>
                <input type="text" name="p12[edge-treatment-amount]" class="input-number" value="0" min="0" max="100">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="plus" data-field="p12[edge-treatment-amount]">
                        <span class="fa fa-plus-circle"></span>
                    </button>
                </span>
            </div>
    ...
    <div class="row down40">
        ...
        <div class="col-xs-12 col-md-3">
            <input type="text" name="p12[frames-cost]" id="frames-cost" class="form-control">
