<div class="down40" id="choice-multifocal-form" style="display:none;"> 
    ...
    <div class="row down40">
        ...
        <div class="col-xs-12 col-md-4">
            <select name="cmf[type]" id="type-select" class="full-width">
        ...
        <div class="col-xs-12 col-md-2">
            <div class="input-group">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="minus" data-field="cmf[type-amount]">
                    <span class="fa fa-minus-circle"></span>
                    </button>
                </span>
                <input type="text" name="cmf[type-amount]" class="input-number" value="0" min="0" max="100">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="plus" data-field="cmf[type-amount]">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
            <select name="cmf[tint]" id="tint-select" class="full-width">
                <option>Select</option>
        ...
        <div class="col-xs-12 col-md-2">
            <div class="input-group">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="minus" data-field="cmf[tint-amount]">
                    <span class="fa fa-minus-circle"></span>
                    </button>
                </span>
                <input type="text" name="cmf[tint-amount]" class="input-number" value="0" min="0" max="100">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="plus" data-field="cmf[tint-amount]">
                        <span class="fa fa-plus-circle"></span>
                    </button>
                </span>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
            <select name="cmf[coating]" id="coating-select" class="full-width">
                <option>Select</option>
        ...
        <div class="col-xs-12 col-md-2">
            <div class="input-group">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="minus" data-field="cmf[coating-amount]">
                    <span class="fa fa-minus-circle"></span>
                    </button>
                </span>
                <input type="text" name="cmf[coating-amount]" class="input-number" value="0" min="0" max="100">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="plus" data-field="cmf[coating-amount]">
                        <span class="fa fa-plus-circle"></span>
                    </button>
                </span>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
            <select name="cmf[edge-treatment]" id="edge-treatment-select" class="full-width">
                <option>Select</option>
        ...
        <div class="col-xs-12 col-md-2">
            <div class="input-group">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="minus" data-field="cmf[edge-treatment-amount]">
                    <span class="fa fa-minus-circle"></span>
                    </button>
                </span>
                <input type="text" name="cmf[edge-treatment-amount]" class="input-number" value="0" min="0" max="100">
                <span class="input-group-btn">
                    <button type="button" class="btn btn-number" data-type="plus" data-field="cmf[edge-treatment-amount]">
                        <span class="fa fa-plus-circle"></span>
                    </button>
                </span>
            </div>
    ...
    <div class="row down40">
        ...
        <div class="col-xs-12 col-md-3">
            <label class="switch">
                <input type="checkbox" name="cmf[new-frames]" id="new-frames">
    ...
    <div id="new-frames-questions-div" style="display:none;">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-3">
                <input type="number" name="cmf[eligible-frames]" id="eligible-frames" class="form-control">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-3">
                <input type="text" name="cmf[frames-cost]" id="frames-cost" class="form-control">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-3">
                <input type="text" name="cmf[frames-allowance]" id="frames-allowance" class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-3">
            <input type="text" name="cmf[exam-copayment]" id="exam-copayment" class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-3">
            <input type="text" name="cmf[material-copayment]" id="material-copayment" class="form-control">
